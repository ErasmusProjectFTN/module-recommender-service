...
public class StringUtils {
    ...
    public static String namespaceModule = "http://www.semanticweb.org/svetozarstojkovic/ontologies/2018/2/module#";
    ...
    public static String e2File = "e2_individuals.owl";
